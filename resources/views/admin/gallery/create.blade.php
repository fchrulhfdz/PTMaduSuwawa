    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Tambah Item Gallery</h1>
                    <p class="mt-2 text-sm text-gray-600">Tambah foto atau video baru ke gallery</p>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="relative flex cursor-pointer">
                            <input type="radio" name="type" value="photo" class="sr-only peer" checked>
                ...
                <div class="grid grid-cols-1 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="3"
                                  class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200"
                                  placeholder="Deskripsi singkat tentang konten...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
