...
<head>
    ...
    <title>Tambah Produk - Smart Cashier</title>
            ...
            <div class="container mx-auto px-4 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-blue-100">Tambah Produk Baru</p>
                    </div>
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Tambahkan produk baru ke katalog Anda</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select name="category" 
                                        ...
                                        <option value="Madu Hutan" {{ old('category') == 'Madu Hutan' ? 'selected' : '' }}>Madu Hutan</option>
                                        <option value="Madu Budidaya" {{ old('category') == 'Madu Budidaya' ? 'selected' : '' }}>Madu Budidaya</option>
                                        <option value="Madu Organik" {{ old('category') == 'Madu Organik' ? 'selected' : '' }}>Madu Organik</option>
                                        <option value="Madu Spesial" {{ old('category') == 'Madu Spesial' ? 'selected' : '' }}>Madu Spesial</option>
                                    </select>
                                    @error('category')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="satuan_berat" 
                                                id="satuan_berat"
                                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
                                            <option value="gram" {{ old('satuan_berat') == 'gram' ? 'selected' : '' }}>Gram</option>
                                            <option value="kg" {{ old('satuan_berat') == 'kg' ? 'selected' : '' }}>Kilogram</option>
                                            <option value="ml" {{ old('satuan_berat') == 'ml' ? 'selected' : '' }}>Mililiter</option>
                                            <option value="liter" {{ old('satuan_berat') == 'liter' ? 'selected' : '' }}>Liter</option>
                                            <option value="pcs" {{ old('satuan_berat') == 'pcs' ? 'selected' : '' }}>Pcs</option>
                                            <option value="botol" {{ old('satuan_berat') == 'botol' ? 'selected' : '' }}>Botol</option>
                                            <option value="pack" {{ old('satuan_berat') == 'pack' ? 'selected' : '' }}>Pack</option>
                                        </select>
                                        @error('satuan_berat')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      id="description" 
                                      rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none"
