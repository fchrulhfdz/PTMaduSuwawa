...
<head>
    ...
    <title>Edit Testimonial - Smart Cashier</title>
            ...
            <div class="container mx-auto px-4 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-blue-100">Edit Testimonial Pelanggan</p>
                    </div>
        ...
        <main class="container mx-auto px-4 py-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600">Edit testimonial pelanggan</p>
                </div>
                <a href="{{ route('admin.testimonials.index') }}" 
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="p-8">
                    <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" id="testimonialForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="customer_title" 
                                           value="{{ old('customer_title', $testimonial->customer_title) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                            ...
                            <div>
                                ...
                                <input type="hidden" name="rating" id="ratingInput" value="{{ old('rating', $testimonial->rating) }}" required>
                                <div class="text-center mt-2">
                                    <span id="ratingText" class="text-sm text-gray-600">Rating: {{ old('rating', $testimonial->rating) }}/5</span>
                                </div>
                                @error('rating')
                            ...
                            <div>
                                ...
                                <textarea name="testimonial" rows="5" required
                                          ...
                                          placeholder="Tulis testimonial pelanggan di sini...">{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                                <div class="flex justify-between mt-1">
                                    <span class="text-xs text-gray-500">Minimal 10 karakter</span>
                                    <span class="text-xs text-gray-500" id="charCount">{{ strlen(old('testimonial', $testimonial->testimonial)) }} karakter</span>
                                </div>
                                @error('testimonial')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
